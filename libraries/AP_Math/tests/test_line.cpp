...
TEST(LineTest, AdjustVelocityTest0)
{
  ...
  // Vector2f intersection and closet point
   ...
   Vector2f start(44.434753f,26.046537);
   Vector2f stop(44.434753f, 26.056557);
   Vector2f currentPosition(44.434753f,26.046537);
   ...
   Vector2f stopping_point = currentPosition + velocity*( 200.0f + 1.0f);
      ...
      EXPECT_TRUE(Vector2f::segment_intersection(currentPosition, stopping_point, line._start, line._stop, intersection));
...
{  /**
   ...
   velocity0 = line.adjust_velocity_Slide(1.0f,currentPosition0,5.0f,velocity,stopping_point0,1.0f,200.0f);
   ...
   Vector2f velocity1 = line.adjust_velocity_Slide(1.0f,currentPosition1,5.0f,velocity,stopping_point1,1.0f,2.0f);
...
TEST(LineTest, adjust_velocity_Slide1)
{
   ...
   velocity0 = line.adjust_velocity_Slide(1.0f,currentPosition,5.0f,velocity,stopping_point,1.0f,1.0f);
    ...
    **/
    ...
    velocity0 = line.adjust_velocity_Slide(1.0f,currentPosition1,5.0f,velocity,stopping_point1,1.0f,1.0f);
...
{  /**
   ...
   velocity0 = line.adjust_velocity_Stop(1.0f,currentPosition,5.0f,velocity,1.0f,200.0f);
  ...
  Vector2f velocity1 = line.adjust_velocity_Stop(1.0f,currentPosition1,5.0f,velocity,1.0f,200.0f);
...
{  /**
   ...
   velocity0 = line.adjust_velocity_Stop(1.0f,currentPosition,5.0f,velocity,1.0f,100.0f);
...
/**
  ...
  **/
  ...
  Vector2f currentPosition1(4.0f,5.0f);
  velocity0 = line.adjust_velocity_Stop(1.0f,currentPosition1,5.0f,velocity,1.0f,1.0f);
